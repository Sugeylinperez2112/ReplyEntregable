...
/*Este agregado te permite diferenciar el elemento componible cuando lo usas de forma independiente
 y cuando lo usas dentro de la pantalla principal.
 */
...
fun ReplyDetailsScreen(
    ...
    Box(modifier = modifier) {
        /*Dentro del elemento ReplyDetailsScreen componible, une el elemento ReplyDetailsScreenTopBar
        con una sentencia if de modo que solo se muestre cuando la app esté en pantalla completa.
         */
        LazyColumn(
            modifier = Modifier
            ...
            /*Pasa el valor isFullScreen al elemento ReplyEmailDetailsCard componible. Pasa un modificador
             *con un padding horizontal de R.dimen.detail_card_outer_padding_horizontal si la pantalla está en
             * modo de pantalla completa y, de lo contrario, pasa un modificador con un padding final de R.dimen.
              *detail_card_outer_padding_horizontal.
             */
            item {
                if (isFullScreen) {
...
//Agrega un valor isFullScreen como parámetro al elemento ReplyEmailDetailsCard componible.
...
private fun ReplyEmailDetailsCard(
    ...
    Card(
        ...
        /*Dado que este diseño ya muestra el asunto del correo electrónico como encabezado. Si está en pantalla completa,
         *agrega un separador con una altura de R.dimen.detail_content_padding_top.
         */
        Column(
            modifier = Modifier
                .fillMaxWidth()
